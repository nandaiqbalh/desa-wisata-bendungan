...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html"><span>Desa </span>Bendungan</a></h1>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>Desa Bendungan</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed with love by <a href="#">Nanda</a>
        </div>
      </div>
